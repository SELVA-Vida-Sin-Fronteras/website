    ...
    <footer className="footer p-5 navbar-fixed-bottom" data-testid="footer">
      <nav className="navbar navbar-expand justify-content-center">
        <ul className="navbar-nav ">
          ...
          <li className="nav-item">
            <a
              href="https://www.instagram.com/friendsofselvausa/"
      ...
      <address className="text-light text-center mt-3">
        Friends of SELVA USA <br></br>
        4468 Stables Lane, Dallas, Texas 75229 <br></br>
        <a href="mailto:fsvfusa@gmail.com">fsvfusa@gmail.com</a>
      </address>
      <small className="text-light text-center">
        &copy; Friends of SELVA Vida Sin Fronteras
      </small>
    </footer>
  );
};
