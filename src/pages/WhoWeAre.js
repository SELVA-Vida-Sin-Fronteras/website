    ...
    <div data-testid="who-we-are" className="bg-light p-5">
      <section className="card mb-4">
        ...
        <p className="card-body">
          ...
          Code. Our organization is focused on assisting the indigenous peoples
          of the Amazon Rainforest to have a viable and sustainable future. We
          intend to create an awareness of the need for preserving and
          protecting the Amazon Rainforest and it's indigenous communities
          through education, educational expeditions, and other means of
          support. We are partners with SELVA Vida Sin Fronteras in Ecuador and
      ...
      <section className="card mb-4">
        ...
        <p className="card-body">
          ...
          exchange of culture and arts. (Our institutional philosophy is guided
          by the principle that Nature and all forms of life have the
